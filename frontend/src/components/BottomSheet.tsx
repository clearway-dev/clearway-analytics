            ...
            {data && (
                <div className="p-6 pb-8">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">{data.name || "Unknown Road"}</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                            <span className="block text-xs text-gray-500 uppercase font-semibold mb-1">Avg Width</span>
                            <span className="text-3xl font-black text-gray-800">{data.avg_width} <span className="text-lg text-gray-400 font-medium">cm</span></span>
                        </div>
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                            <span className="block text-xs text-gray-500 uppercase font-semibold mb-1">Confidence</span>
                            <span className="text-lg font-bold text-gray-700">High</span>
                            <span className="block text-xs text-gray-400 mt-1">{data.measurements_count} measurements</span>
                        </div>
                    </div>
                </div>
            )}
